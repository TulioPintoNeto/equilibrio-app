...
export const Loading = styled.progress<{ $color?: string, $size?: string }>`
  ...
  &:indeterminate {
    ...
    mask-image: linear-gradient(transparent 50%, black 50%),
      linear-gradient(to right, transparent 50%, black 50%);
    animation: loading 6s infinite cubic-bezier(0.3, 0.6, 1, 1);
  }
  ...
  &:indeterminate::-webkit-progress-value {
    ...
    height: 100%;
    background-color: transparent;
    animation: loadingPseudo 0.75s infinite linear alternate;
  }
